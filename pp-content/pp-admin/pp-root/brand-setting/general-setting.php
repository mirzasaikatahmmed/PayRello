                            ...
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="border rounded p-2 mt-2 d-flex align-items-center justify-content-center" style=" height: 90px; width: 90px; ">
                                        <img src="<?php echo ($global_response_brand['response'][0]['favicon'] === '--' || $global_response_brand['response'][0]['favicon'] === '') ? $payrello_favicon : $global_response_brand['response'][0]['favicon'];?>" accept="image/*" alt="" id="preview1">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="border rounded p-2 mt-2 d-flex align-items-center justify-content-center" style=" height: 90px; max-width: 300px; ">
                                        <img src="<?php echo ($global_response_brand['response'][0]['logo'] === '--' || $global_response_brand['response'][0]['logo'] === '') ? $payrello_logo_light : $global_response_brand['response'][0]['logo'];?>" accept="image/*" alt="" id="preview2" style=" max-width: 100%; max-height: 100%; ">
                                    </div>
                                </div>
                            </div>
                        </div>
