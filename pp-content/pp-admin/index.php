...
<head>
    ...
    <title>Payrello</title>
    <link rel="shortcut icon" href="<?= $payrello_favicon ?? '' ?>">
          ...
          <div class="container-xl">
            ...
            <div class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
              <a href="javascript:void(0)" aria-label="Tabler">
                  <img src="<?= $payrello_logo_light ?? '' ?>" alt="" style="height: 32px;" onclick="load_content('Dashboard','<?php echo $site_url.$path_admin ?>/dashboard','nav-menu-dashboard')">
              </a>
            </div>
            <!-- END NAVBAR LOGO -->
                    ...
                    <div class="row text-center align-items-center flex-row-reverse">
                        <div class="col-lg-auto ms-lg-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item"><a href="https://help.payrello.com/" target="_blank" class="link-secondary" rel="noopener">Documentation</a></li>
                                <li class="list-inline-item"><a href="https://github.com/payrello" target="_blank" class="link-secondary">Modules</a></li>
                            </ul>
                        </div>
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item">
                                    © <?php echo date('Y');?>
                                    <a href="https://payrello.com/" class="link-secondary" target="blank">Payrello</a>. All rights reserved.
                                </li>
                                <li class="list-inline-item">
                                    <a href="https://updates.payrello.com/?version=<?php echo $payrello_current_version['version_code'];?>" class="link-secondary" target="blank"target="blank"> <?php echo $payrello_current_version['version_name'];?> </a>
                                </li>
                            </ul>
                        </div>
                    </div>
