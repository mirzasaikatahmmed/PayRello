    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            <div class="text-center mb-4">
                <img src="<?= $payrello_logo_light ?? '' ?>" alt="" style=" height: 40px; ">
            </div>
                ...
                <div class="card-body">
                    ...
                    <form action="" class="form-method">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="username" placeholder="Enter email or username" value="<?php echo isset($pp_demo_mode) ? "demo@payrello.com" : ""; ?>" required>
                        </div>
                        <div class="mb-2">
