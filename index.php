                            ...
                            if($response_brand['status'] == true){
                                ...
                                if(file_exists(__DIR__.'/pp-content/pp-modules/pp-gateways/'.$response_gateway['response'][0]['slug'].'/class.php')){
                                    ...
                                    $brandInfo = [
                                        ...
                                        'logo'          => $brandRow['logo'] !== '--' ? $brandRow['logo'] : 'https://help.payrello.com/storage/branding_media/8a5c6ee4-8eba-401d-bffb-c43006d5f65d.png',
                                        'favicon'       => $brandRow['favicon'] !== '--' ? $brandRow['favicon'] : 'https://help.payrello.com/favicon/icon-144x144.png',
